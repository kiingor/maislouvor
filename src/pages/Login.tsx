...
export default function Login() {
  ...
  const handleForgotPassword = async () => {
    if (!email) {
      toast({ title: "Informe seu email", description: "Digite seu email para receber o link de redefinição.", variant: "destructive" });
      return;
    }
          ...
          <div className="animate-in-up" style={{ animationDelay: "150ms" }}>
            <GlassCard className="p-6 lg:p-10 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-lg font-semibold tracking-tight mb-1">Bem-vindo de volta</h3>
